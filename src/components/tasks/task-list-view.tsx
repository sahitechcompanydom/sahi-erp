...
import { Circle, Clock, CheckCircle, CheckCheck, MessageSquare } from "lucide-react";
      ...
      <table className="w-full min-w-[640px] text-left text-sm">
        <thead>
          <tr className="border-b border-border bg-muted/30">
            <th className="w-12 px-4 py-3 font-medium text-muted-foreground" aria-label="Status" />
            ...
            <th className="w-14 px-4 py-3" aria-label="Quick approve" />
          </tr>
        </thead>
        <tbody>
          {tasks.map((task) => {
